...
void func_80105A64_ChillyWaters(void);
void func_8010BCA4_boardresult(void);
void func_800555E8_main(s16 group, s16 member, u16 arg2, u16 arg3, u16 arg4, u16 arg5);

void func_801059D0_ChillyWaters(s16 arg0, s16 arg1) {
    Process *process;
    unkfunc_801059D0 *temp_v0;

    process = omAddPrcObj(func_80105A64_ChillyWaters, 0x3F00, 0x1000, 0);
...
void func_80105A64_ChillyWaters(void) {
    ...
    sprId = func_8000B838_main(0xB004A);
    work->unk8 = sprId;
    grpId = HuSprGrpCreate(1, 0);
    work->unkA = grpId;
    func_80055024_main(grpId, 0, sprId, 0);
    func_80054904_main(grpId, 0, work->unk0, work->unk4);
    HuSprAttrSet(grpId, 0, 0x5000);
    func_80055420_main(grpId, 0, 0x20, 0xA0, 0x90);
    func_800555E8_main(grpId, 0, 0x10, 0xC, 0x130, 0xE4);
...
void func_80105DB8_ChillyWaters(IceWork* arg0) {
...
void func_80105E20_ChillyWaters(IceWork* arg0, f32 x, f32 y) {
    arg0->unk0 = x;
    arg0->unk4 = y;
    func_80054904_main(arg0->unkA, 0, arg0->unk0, arg0->unk4);
}
