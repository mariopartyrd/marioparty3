...
extern u8 D_801068C0_storydebug[512];

void func_80106108_storydebug(omObjData *);
void func_80106134_storydebug(void);
void func_80105C6C_storydebug(s16 arg0);
void func_801062A0_storydebug(void);
...
void func_801059D0_storydebug(void) {
    ...
    omAddPrcObj(func_80106134_storydebug, 0xE000, 0, 0);
    omAddObj(0x500, 0, 0, -1, func_80106108_storydebug);
    WipeCreateIn(0, 0);
}

void func_80105A98_storydebug(void) {
    s32 var_s2;
    s32 i, j;
    ...
    for (i = 0; i < 16 && (i * 8) < ARRAY_COUNT(D_801068C0_storydebug); i++) {
        sprintf(D_800D5218_main, "%3X:", var_s2);
        print8(40, (i * 10 + 48), D_800D5218_main);
        for (j = 0; j < 8; j++) {
            sprintf(D_800D5218_main, "%02X", D_801068C0_storydebug[var_s2 + j]);
            print8((j * 24 + 80), (i * 10 + 48), D_800D5218_main);
        }
        var_s2 += 8;
    }
}

void func_80105BB4_storydebug(void) {
    s16 var_s1;
    s16 i;
    ...
    while (1) {
        ...
        for (i = var_s1; i < var_s1 + 2; i++) {
            func_80105C6C_storydebug(i);
        }
    }
}

void func_80105C6C_storydebug(s16 playerIndex) {
    char buffer[256];
...
void func_80106108_storydebug(omObjData *arg0) {
