...
void func_801059D0_467600_storydebug(void) {
    ...
    omAddPrcObj(func_80106134_467D64_storydebug, 0xE000, 0, 0);
    omAddObj(0x500, 0, 0, -1, func_80106108_467D38_storydebug);
    WipeCreateIn(0, 0);
}

void func_80105A98_4676C8_storydebug(void) {
    s32 var_s2;
    s32 i, j;
    ...
    for (i = 0; i < 16 && (i * 8) < ARRAY_COUNT(D_801068C0_4684F0_storydebug); i++) {
        ...
        for (j = 0; j < 8; j++) {
            sprintf(D_800D5218_D5E18, "%02X", D_801068C0_4684F0_storydebug[var_s2 + j]);
...
void func_80105BB4_4677E4_storydebug(void) {
    s16 var_s1;
    s16 i;
...
void func_80105C6C_46789C_storydebug(s16 playerIndex) {
    char buffer[256];
...
void func_80106134_467D64_storydebug(void) {
    ...
    while (1) {
        HuPrcVSleep();
        func_801062A0_467ED0_storydebug();
        if (D_800D5558_D6158[0] & 0x8000) {
