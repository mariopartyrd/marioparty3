...
void func_800FFAE0_name_81(s16 playerNo, s16 arg1) {
...
void func_800FFBEC_name_81(void) {
    UnkE78B0 *temp_s0 = (UnkE78B0 *)HuPrcCurrentGet()->user_data;

    while (1) {
        func_800FFAE0_name_81(temp_s0->unk_00, temp_s0->unk_02);
        HuPrcSleep(temp_s0->unk_04);
    }
}

void *func_800FFC2C_name_81(s16 arg0, s16 arg1, s32 arg2) {
    Process *process;
    s16 temp_s1;
    UnkE78B0 *unk;
    static s8 D_80101B10_name_81[] = { 5, 10, 10, 20, 20, 30 };

    temp_s1 = D_80101B10_name_81[arg1] + arg2;
    ...
    if (unk != NULL) {
        ...
        process = omAddPrcObj(func_800FFBEC_name_81, 0x1005, 0, 0);
        unk->proc = process;
...
void func_800FFCCC_name_81(UnkE78B0 *arg0) {
    if (arg0 != NULL) {
