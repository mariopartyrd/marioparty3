...
#define FGRP_PLAYER_START FGRP_PLAYER_1
...
void o39_InitCamera(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_CheckMinigameEnd(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_ExecPlayersDraw(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_ExecClockIntro(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdateClockSpeed(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdateClockObstacleRotation(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdateClockPlatformRotation(FuncGroupContext* groupCtx, FuncContext* ctx);
f32 o39_GetRandInRange(s16 min, s16 max);
void o39_CheckPlayerJumpStart(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdatePlayerPosition(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdatePlayerRotation(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdatePlayerJump(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_CheckPlayerCollision(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_ExecPlayerIntro(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_ExecPlayerWins(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_ExecPlayerKnockedOut(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdatePlayerAnimation(FuncGroupContext* groupCtx, FuncContext* ctx);
...
void o39_InitCom(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_ResetPlayerInput(FuncGroupContext* groupCtx, FuncContext* ctx);
void o39_UpdateComInput(FuncGroupContext* groupCtx, FuncContext* ctx);
...
void o39_UpdateCamera(void) {
    ...
    o39_UpdateFuncGroup(FGRP_CAMERA);
}
...
void o39_InitMinigame(omObjData* object) {
    ...
    o39_CreateFuncGroup(NULL, FGRP_CAMERA, 0, 4);
    o39_SetFunc(FGRP_CAMERA, 0, NULL, o39_InitCamera, 0);
    ...
    createCollidersCtx = &o39_funcGroups[object->work[1]].funcCtx[createCollidersId];
...
void o39_UpdateSystem(omObjData* object) {
    o39_UpdateFuncGroup(FGRP_MINIGAME);
    o39_UpdateCamera();
    o39_UpdateSprites();
...
void o39_InitClock(omObjData* object) {
    ...
    groupCtx = o39_CreateFuncGroup(object, FGRP_CLOCK, 5, 16)->groupCtx;
    groupCtx->modelIds[MDL_PLATFORM] = o39_minigame->clockHandModel[HAND_PLATFORM] = func_8000B108_BD08(0x5A0000, var_s4);
    groupCtx->modelIds[MDL_OBSTACLE] = o39_minigame->clockHandModel[HAND_OBSTACLE] = func_8000B108_BD08(0x5A0001, var_s4);
    ...
    Hu3DModelRotSet(groupCtx->modelIds[MDL_PLATFORM], 0.0f, o39_minigame->clockHandRot[HAND_PLATFORM], 0.0f);
    Hu3DModelRotSet(groupCtx->modelIds[MDL_OBSTACLE], 0.0f, o39_minigame->clockHandRot[HAND_OBSTACLE], 0.0f);
    ...
    o39_SetFunc(FGRP_CLOCK, 0xF, NULL, o39_UpdateClockPlatformRotation, 0);
    o39_SetFunc(FGRP_CLOCK, 0xF, NULL, o39_UpdateClockObstacleRotation, 0);
    o39_minigame->obstacleColliderId = o39_SetCollider(groupCtx->modelIds[MDL_PLATFORM], &obstacleQuad, 25.0f, PLAYERS_TOTAL, COLLIDER_ATTR_DISABLED);
    o39_minigame->obstacleProximityColliderId = o39_SetCollider(groupCtx->modelIds[MDL_PLATFORM], &obstacleProximityQuad, 0.0f, PLAYERS_TOTAL, COLLIDER_ATTR_HEIGHT_DISABLED);
    ...
    o39_SetFunc(FGRP_CLOCK, 0, NULL, o39_ExecClockIntro, 0);
    object->func = o39_UpdateClockHands;
}

void o39_UpdateClockHands(omObjData* object) {
    o39_UpdateFuncGroup(FGRP_CLOCK);
    o39_SyncWithModel(object);
}
...
void o39_InitPlayer(omObjData* object) {
    ...
    object->work[1] = FGRP_PLAYER_START + object->work[0];
...
void o39_InitCamera(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    CRot.z = 0.0f;
    CZoom = 990.0f;
    o39_ResetFunc(FGRP_CAMERA, ctx);
}

void o39_UpdateJumpCounterSprites(FuncGroupContext* groupCtx, FuncContext* ctx) {
...
void o39_ExecMinigameStart(FuncGroupContext* groupCtx, FuncContext* ctx) {
    s16 i;
            ...
            if (D_8010E4A2_2C5912_tick_tock_hop && func_80037030_37C30() == 2) {
                ...
                for (i = 0; i < PLAYERS_TOTAL; i++) {
                    if (GwPlayer[o39_playerId[i]].stat & PLAYER_IS_CPU) {
                        o39_SetFunc(FGRP_PLAYER_START + i, 0, &o39_players[i], o39_InitCom, 0);
                    } else {
                        o39_ResetFunc(o39_players[i].resetInputGroupId, &o39_funcGroups[o39_players[i].resetInputGroupId].funcCtx[o39_players[i].resetInputId]);
                    }
                }
                o39_SetFunc(FGRP_MINIGAME, 0, NULL, o39_UpdateJumpCounterSprites, 0);
                ctx->func = o39_CheckMinigameEnd;
            }
            break;
    }
...
void o39_ExitOverlayOnWipeOut(FuncGroupContext* groupCtx, FuncContext* ctx) {
    switch (ctx->state) {
        case 0:
            WipeCreateOut(0, 20);
            ctx->state = 1;
...
void o39_CheckMinigameEnd(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (o39_minigame->jumpCount == JUMPS_MAX) {
        ...
        if (ABS(clockObstacleRot - clockPlatformRot) > 90.0f) {
            ...
            o39_SetFunc(FGRP_MINIGAME, 0, NULL, o39_ExecPlayersDraw, 0);
            for (i = 0; i < PLAYERS_TOTAL; i++) {
                o39_players[i].stat |= PLAYER_STAT_LOST;
            }
            o39_ResetFunc(FGRP_MINIGAME, ctx);
        }
    } else {
        loserCount = 0;
        ...
        if (ABS(clockObstacleRot - clockPlatformRot) > 90.0f) {
            ...
            if (loserCount == PLAYERS_TOTAL) {
                ...
                o39_SetFunc(FGRP_PLAYER_START + winner, 0xFF, &o39_players[winner], o39_ExecPlayerWins, 0);
                o39_ResetFunc(FGRP_MINIGAME, ctx);
            }
        }
    }
...
void o39_ExecBothPlayersWin(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (o39_bothPlayersWinState == 0) {
        ...
        if (o39_bothPlayersWinState == 3) {
            ctx->work.work16[0]++;
            if (ctx->work.work16[0] >= 15) {
                o39_ResetFunc(FGRP_MINIGAME, ctx);
                o39_SetFunc(FGRP_MINIGAME, 0, NULL, o39_ExitOverlayOnWipeOut, 0);
            }
        }
    } else {
        ctx->work.work16[0]++;
...
void o39_ExecClockIntro(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    switch (ctx->state) {
        case 0:
            ...
            ctx->work.work16[3] = 0;
            for (i = 0; i < PLAYERS_TOTAL; i++) {
                ctx->work.work16[i] = o39_SetFunc(FGRP_PLAYER_START + i, 0xF, &o39_players[i], o39_ExecPlayerIntro, 0);
            }
            ctx->state = 1;
            break;
        case 1:
            ctx->work.work16[3]++;
            if (ctx->work.work16[3] < 30.0f) {
                return;
            }
            ctx->state = 2;
            HuAudFXPlay(0x4BB);
            ctx->work.work16[4] = HuAudFXPlay(0x4BC);
            func_8004ABE8_4B7E8(ctx->work.work16[4], 0);
            break;
    }
    if (ctx->work.work8[0] == 0) {
        ...
        if (o39_minigame->clockHandRot[HAND_OBSTACLE] < 180.0f) {
            func_8004AD50_4B950(ctx->work.work16[4]);
            ctx->work.work8[4] = 0;
            ctx->work.work8[0] = 1;
        }
    } else if (++ctx->work.work8[0] >= 11) {
        if (ctx->work.work8[1] == 0) {
            ctx->work.work16[4] = HuAudFXPlay(0x4BC);
            func_8004ABE8_4B7E8(ctx->work.work16[4], 0);
            HuAudFXPlay(0x4BB);
            ctx->work.work8[1] = 1;
        ...
        if (o39_minigame->clockHandRot[HAND_OBSTACLE] > 360.0f) {
            o39_SetFunc(FGRP_MINIGAME, 0, NULL, o39_ExecMinigameStart, 0);
            for (i = 0; i < PLAYERS_TOTAL; i++) {
                o39_ResetFunc(FGRP_PLAYER_START + i, &o39_funcGroups[FGRP_PLAYER_START + i].funcCtx[ctx->work.work16[i]]);
            }
...
void o39_UpdateClockSpeed(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (o39_minigame->jumpsSinceSpeedChange > o39_minigame->jumpsForSpeedChange) {
        if (!ctx->work.work8[1]) {
            fxPlayed = FALSE;
            ctx->work.work8[1] = TRUE;
            ctx->work.workF[3] = 120 + rand16() % 60;
            switch (rand16() % 3) {
                case 0:
                    if (rand16() & 1) {
                        ctx->work.workF[0] = 0.0f;
                        ctx->work.workF[1] = o39_GetRandInRange(3, 4);
                    } else {
                        ctx->work.workF[0] = o39_GetRandInRange(3, 4);
                        ctx->work.workF[1] = 0.0f;
                    }
                    break;
                case 1:
                    if (rand16() & 1) {
                        if (rand16() & 1) {
                            ctx->work.workF[0] = 3.0f;
                            ctx->work.workF[1] = 1.0f;
                        } else {
                            ctx->work.workF[0] = 1.0f;
                            ctx->work.workF[1] = 3.0f;
                        }
                    } else {
                        if (rand16() & 1) {
                            ctx->work.workF[0] = -3.0f;
                    ...
                    break;
                case 2:
                    ctx->work.workF[0] = o39_GetRandInRange(2, 3);
                    if (ctx->work.workF[0] > 0.0f) {
                        ctx->work.workF[1] = -(f32) (2 + (rand16() & 1));
                    } else {
                        ctx->work.workF[1] = (f32) (2 + (rand16() & 1));
                    }
                    break;
            ...
            o39_MinimizeAngleDiff(&clockObstacleRot, &clockPlatformRot);
            if (ABS(clockObstacleRot - clockPlatformRot) > ctx->work.workF[3]) {
                ...
                o39_minigame->clockBaseSpeed[HAND_OBSTACLE] = ctx->work.workF[0];
                o39_minigame->clockBaseSpeed[HAND_PLATFORM] = ctx->work.workF[1];
                ctx->work.work8[1] = FALSE;
                o39_minigame->jumpsSinceSpeedChange = 0;
...
void o39_UpdateClockObstacleRotation(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    Hu3DModelRotSet(groupCtx->modelIds[MDL_PLATFORM], 0.0f, o39_minigame->clockHandRot[HAND_OBSTACLE], 0.0f);
    if (o39_minigame->clockBaseSpeed[HAND_OBSTACLE] != 0.0f) {
        if (ctx->work.work8[0] == 0) {
            var_s1 = ctx->work.work16[0] = HuAudFXPlay(0x4BC);
            ctx->work.work8[0] = 1;
        }
...
void o39_UpdateClockPlatformRotation(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    Hu3DModelRotSet(groupCtx->modelIds[MDL_OBSTACLE], 0.0f, o39_minigame->clockHandRot[HAND_PLATFORM], 0.0f);
    if (o39_minigame->clockBaseSpeed[HAND_PLATFORM] != 0.0f) {
        if (ctx->work.work8[0] == 0) {
            var_s1 = ctx->work.work16[0] = HuAudFXPlay(0x4BD);
            ctx->work.work8[0] = 1;
        }
        var_a1_0 = o39_minigame->clockSpeedMultiplier * 150.0f;
...
void o39_CheckPlayerJumpStart(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (player->stat & PLAYER_STAT_FINISHED) {
        o39_ResetFunc(object->work[1], ctx);
        return;
    }
    if (D_800CDA7C_CE67C[player->padId] & A_BUTTON) {
        if (ctx->work.work8[0] == 0 && !(player->stat & PLAYER_STAT_JUMPING) && player->state != PLAYER_STATE_LAND) {
            ctx->work.work8[0] = 1;
            player->stat |= PLAYER_STAT_JUMPING;
            playerJumpId = o39_SetFunc(object->work[1], 0xEFFF, player, o39_UpdatePlayerJump, 0);
            playerJumpCtx = &o39_funcGroups[object->work[1]].funcCtx[playerJumpId];
...
void o39_UpdatePlayerPosition(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (ctx->state == 0) {
        if (o39_playerOrder[object->work[0]] == 0) {
            ctx->work.workF[0] = 185.0f;
            ctx->work.workF[1] = 185.0f;
        } else {
            ctx->work.workF[0] = 315.0f;
            ctx->work.workF[1] = 315.0f;
        }
        ctx->state = 1;
    }
    object->trans.x = HuMathSin(clockPlatformRot) * ctx->work.workF[0];
    object->trans.z = HuMathCos(clockPlatformRot) * ctx->work.workF[1];
...
void o39_ExecPlayerIntro(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (player->obstacleProximityTracker->colliding) {
        ctx->work.work8[1] = 1;
        ctx->work.work8[0]++;
        if (ctx->work.work8[0] < 5) {
            D_800CDA7C_CE67C[player->padId] = A_BUTTON;
        }
    } else {
        ctx->work.work8[0] = 0;
        if (ctx->work.work8[1] != 0 && ctx->work.work8[2] == 0) {
            D_800CBB6E_CC76E[player->padId] = HuMathSin(ctx->work.workF[0]) * 70.0f;
            D_800D20A1_D2CA1[player->padId] = HuMathCos(ctx->work.workF[0]) * 70.0f;
            ctx->work.workF[0] += 10.0f;
            if (ctx->work.workF[0] > 180.0f) {
                ctx->work.workF[0] = 180.0f;
                ctx->work.work8[2] = 1;
            }
        }
    }
...
void o39_ExecPlayerWins(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    switch (ctx->state) {
        ...
        case 1: // Face the camera.
            lerpT = ctx->work.work16[0] / 10.0f;
            if (lerpT > 1.0f) {
                lerpT = 1.0f;
            }
            object->rot.y = (180.0f - ctx->work.workF[0]) * lerpT + ctx->work.workF[0];
            ctx->work.work16[0]++;
            if (ctx->work.work16[0] >= 11) {
                ctx->work.work16[0] = 0;
                object->rot.y = 180.0f;
                o39_SetPlayerState(player, PLAYER_STATE_IDLE, TRUE);
                ctx->state = 2;
        ...
        default:
            if (o39_minigame->jumpCount == JUMPS_MAX) { // Always false?
                o39_SetFunc(FGRP_MINIGAME, 0, NULL, o39_ExecBothPlayersWin, 0);
                o39_ResetFunc(object->work[1], ctx);
                break;
            }
...
void o39_ExecPlayerKnockedOut(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (ctx->state == 0) {
        ...
        ctx->work.workF[0] = o39_minigame->clockHandRot[HAND_PLATFORM] + rotDirection * 90.0f;
        while (ctx->work.workF[0] < 0.0f) {
            ctx->work.workF[0] += 360.0f;
        }
        while (ctx->work.workF[0] > 360.0f) {
            ctx->work.workF[0] -= 360.0f;
        }
        ctx->work.workF[1] = ctx->work.workF[2] = HuMathSin(45.0f) * 60.000004f;
        ctx->work.work16[0] = 0;
    ...
    object->trans.y += ctx->work.workF[1];
    ctx->work.workF[1] = ctx->work.workF[2] - ctx->work.work16[0] * 2.45f;
    ctx->work.work16[0]++;
    object->trans.x += HuMathSin(ctx->work.workF[0]) * 20.0f * 5.0f * 0.25f;
    object->trans.z += HuMathCos(ctx->work.workF[0]) * 20.0f * 5.0f * 0.25f;
...
void o39_UpdateComInput(FuncGroupContext* groupCtx, FuncContext* ctx) {
    ...
    if (ctx->work.work8[0] == 1) {
        ctx->work.work16[0]++;
        if (ctx->work.work16[0] > rand16() % (player->comReactionDelay + 1)) {
            ctx->work.work16[0] = 0;
            ctx->work.work8[0] = 2;
    ...
    if (ctx->work.work8[0] == 2) {
        ctx->work.work16[0]++;
        if (ctx->work.work16[0] <= ctx->work.work16[1]) {
            D_800CDA7C_CE67C[player->padId] = A_BUTTON;
        } else {
            ctx->work.work16[0] = 0;
            ctx->work.work8[0] = 0;
