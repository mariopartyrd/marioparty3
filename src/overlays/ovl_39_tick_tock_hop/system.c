...
void M257_CreateSystem(void) {
    M257_sprites = HuMemAllocTag(SPRITES_MAX * sizeof(*M257_sprites), 31000);
    memset(M257_sprites, 0, SPRITES_MAX * sizeof(*M257_sprites));
    M257_animModels = HuMemAllocTag(ANIMMDL_MAX * sizeof(*M257_animModels), 31000);
    memset(M257_animModels, 0, ANIMMDL_MAX * sizeof(*M257_animModels));
    M257_billboards = HuMemAllocTag(BILLS_MAX * sizeof(*M257_billboards), 31000);
    memset(M257_billboards, 0, BILLS_MAX * sizeof(*M257_billboards));
    M257_funcGroups = HuMemAllocTag(5 * sizeof(*M257_funcGroups), 31000);
}
...
void M257_CreateColliders(FuncGroupContext* groupCtx, FuncContext* ctx) {
    M257_colliders = HuMemAllocTag(COLLIDERS_MAX * sizeof(*M257_colliders), 31000);
    memset(M257_colliders, 0, COLLIDERS_MAX * sizeof(*M257_colliders));
