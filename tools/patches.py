...
filedata = filedata.replace('$a0, 0x121', '$a0, %hi(bin_strings_japanese_ROM_START)')
filedata = filedata.replace('$a0, $a0, -0x67b0', '$a0, $a0, %lo(bin_strings_japanese_ROM_START)')

filedata = filedata.replace('$a0, 0x122', '$a0, %hi(bin_strings_english_ROM_START)')
filedata = filedata.replace('$a0, $a0, -0x3560', '$a0, $a0, %lo(bin_strings_english_ROM_START)')

filedata = filedata.replace('$a0, 0x125', '$a0, %hi(bin_strings_french_ROM_START)')
filedata = filedata.replace('$a0, $a0, -0x2bc0', '$a0, $a0, %lo(bin_strings_french_ROM_START)')

filedata = filedata.replace('$a0, 0x123', '$a0, %hi(bin_strings_german_ROM_START)')
filedata = filedata.replace('$a0, $a0, 0x55c0', '$a0, $a0, %lo(bin_strings_german_ROM_START)')

filedata = filedata.replace('$a0, 0x127', '$a0, %hi(bin_strings_spanish_ROM_START)')
filedata = filedata.replace('$a0, $a0, 0x65f0', '$a0, $a0, %lo(bin_strings_spanish_ROM_START)')

filedata = filedata.replace('$a0, 0x126', '$a0, %hi(bin_strings_italian_ROM_START)')
filedata = filedata.replace('$a0, $a0, 0x1f90', '$a0, $a0, %lo(bin_strings_italian_ROM_START)')
