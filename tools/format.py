...
# Based on https://github.com/zeldaret/mm/blob/main/tools/format.py
...
# This specific version is used for more consistency between contributors
CLANG_VER = 19
...
if CLANG_FORMAT is None:
    sys.exit(f"Error: neither clang-format-{CLANG_VER} nor clang-format found")
